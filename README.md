...
---------
Адреса открытых ресурсов

Zabbix-server:  http://158.160.161.8/zabbix (Учетные данные для входа направлю при личном запросе в loop)

Kibana: http://158.160.130.4:5601/ (Аутентификация не требуется)

Web-balancer:  http://130.193.46.222/
